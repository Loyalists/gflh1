function frontend()
    LUI.onmenuopen("main_lockout", function(menu)
        PersistentBackground.ChangeBackground("h1_gfl_menu_background", nil, false)
    end)

    LUI.onmenuopen("main_menu", function(menu)
        PersistentBackground.ChangeBackground("h1_gfl_menu_background_greyscale", nil, false)
    end)
